...
export class Avators extends React.Component{
    ...
    render(){
        const menu = (
            <Menu>
                <Menu.Item key="0">
                    <NavLink to="/24986/first" >
                        <div>
                            <div style={{display:"flex"}}>
                                <div><Avatar size="large" src={store.getData.imageurl} shape="circle" /></div>
                ...
                <Menu.Item key="2">
                    <NavLink to="/24986/first" target="_parent"><Icon className="setc" type="person"/><span className="setc">个人信息</span></NavLink>
                </Menu.Item>
                <Menu.Item key="3">
        ...
        return(<div>
            <Dropdown overlay={menu} trigger={['click']}>
                <a className="ant-dropdown-link" href="#">
                    <Avatar size="large" src={store.getData.imageurl}/>
                </a>
            </Dropdown>
        </div>)
    }
